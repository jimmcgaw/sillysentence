...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.generateNewSentence = _this.generateNewSentence.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    key: 'generateNewSentence',
	    value: function generateNewSentence() {
	      var _this2 = this;

	      (0, _jquery.get)('/sentence').done(function (response) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: 'subject', style: subjectStyles },
	            this.state.subject
	          ),
	          ' ',
	          _react2.default.createElement(
	            'span',
	            { className: 'predicate', style: predicateStyles },
	            this.state.predicate
	          )
	        ),
	        _react2.default.createElement(
	          'button',
	          { className: 'btn btn-primary', onClick: this.generateNewSentence },
	          'Generate'
	        )
	      );
	    }
